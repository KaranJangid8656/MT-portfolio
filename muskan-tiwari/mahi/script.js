    ...
    featuredProjects: [
        {
            ...
            links: [
                { name: 'HOW WE BUILT IT — BLOG ↗', url: 'https://medium.com/@MuskanTiwari951/we-built-a-no-code-ai-agent-platform-in-24-hours-99c6fffc4010' }
            ]
        },
        {
            title: 'CodeSense',
        ...
        },
        {
            ...
            links: [
                ...
                { name: 'GITHUB ↗', url: 'https://github.com/MuskanTiwari0709/ai-interview-coach' }
            ]
        },
        {
            ...
            links: [
                { name: 'PROJECT ↗', url: 'https://MuskanTiwari0709.github.io/Data_mining_Project/' },
                { name: 'GITHUB ↗', url: 'https://github.com/MuskanTiwari0709/Data_mining_Project' }
            ]
        }
    ],
    ...
    additionalProjects: [
        {
            ...
            links: [
                ...
                { name: 'GITHUB ↗', url: 'https://github.com/MuskanTiwari0709/Yoga_Pose_Estimation' }
            ]
        },
        {
            ...
            metric: '7 ML METHODS',
            links: [{ name: 'PROJECT ↗', url: 'https://MuskanTiwari0709.github.io/ml-project/' }]
        },
        {
            ...
            metric: '92% ACCURACY',
            links: [{ name: 'GITHUB ↗', url: 'https://github.com/MuskanTiwari0709/sign_language_recognition' }]
        },
        {
...
function splitHeroName() {
    ...
    if (!h1) return;
    let idx = 0;
    h1.innerHTML = ['Muskan', 'Tiwari'].map(word =>
